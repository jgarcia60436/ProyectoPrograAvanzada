    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categorias != null ? 
                          ...
                          Problem("Entity set 'BibliotecaContext.Categorias'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreCategoria,Descripcion")] Categoria categoria)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaContext.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
