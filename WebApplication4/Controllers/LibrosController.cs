...
namespace WebApplication4.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,AutorId,Genero,AnioPublicacion,Isbn,EditorialId")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,AutorId,Genero,AnioPublicacion,Isbn,EditorialId")] Libro libro)
        {
            if (id != libro.Id)
            {
                return NotFound();
