    ...
    public class AutoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Autores != null ? 
                          ...
                          Problem("Entity set 'BibliotecaContext.Autores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Nacionalidad,FechaNacimiento,Biografia")] Autore autore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Nacionalidad,FechaNacimiento,Biografia")] Autore autore)
        {
            if (id != autore.Id)
            {
                return NotFound();
