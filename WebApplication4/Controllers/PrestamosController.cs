...
namespace WebApplication4.Controllers
{
    public class PrestamosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LibroId,UsuarioId,FechaPrestamo,FechaDevolucion,EstadoPrestamo")] Prestamo prestamo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LibroId,UsuarioId,FechaPrestamo,FechaDevolucion,EstadoPrestamo")] Prestamo prestamo)
        {
            if (id != prestamo.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BibliotecaContext.Prestamos'  is null.");
            }
            var prestamo = await _context.Prestamos.FindAsync(id);
            if (prestamo != null)
            {
